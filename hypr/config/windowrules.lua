...
hl.window_rule({ match = { class = "^(vesktop|discord)$" }, workspace = 2 })
...
hl.window_rule({ match = { class = "^(vesktop|discord)$" }, opacity = "0.6 0.6" })
hl.window_rule({ match = { class = "^(Spotify)$" }, opacity = "0.6 0.6" })
hl.window_rule({ match = { class = "^(rofi)$" }, opacity = "0.6 0.6"})
